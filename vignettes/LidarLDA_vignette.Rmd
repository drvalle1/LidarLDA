...
Finally, to reduce the number of light pulses, ensure an approximately even number of pulses in each height bin in each pixel (here arbitrarily set to 100), and ensure more rapid convergence, we finish formatting these data using the following code.
